...
class OpcoesAgendamento extends StatefulWidget {
  @override
  _OpcoesAgendamentoState createState() => _OpcoesAgendamentoState();
}

class _OpcoesAgendamentoState extends State<OpcoesAgendamento> {
