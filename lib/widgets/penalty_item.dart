...
class PenaltyItem extends StatefulWidget {
  final Penalidade _penalidade;

  PenaltyItem(this._penalidade);

  @override
  _PenaltyItemState createState() => _PenaltyItemState();
}

class _PenaltyItemState extends State<PenaltyItem> {
