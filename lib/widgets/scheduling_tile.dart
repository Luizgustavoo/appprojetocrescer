...
class SchedulingItem extends StatefulWidget {
  final AgendamentoAtendimento agendamento;

  SchedulingItem(this.agendamento);

  @override
  _SchedulingItemState createState() => _SchedulingItemState();
}

class _SchedulingItemState extends State<SchedulingItem> {
